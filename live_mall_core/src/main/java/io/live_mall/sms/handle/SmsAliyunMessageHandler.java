package io.live_mall.sms.handle;
...
import io.live_mall.sms.config.SmsAliyunPropertiesConfig;
...
public class SmsAliyunMessageHandler {
    ...
    public boolean process(MobileMsgTemplate mobileMsgTemplate) {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName(smsAliyunPropertiesConfig.getSignName());

        //必填:短信模板-可在短信控制台中找到
        String templateCode = smsAliyunPropertiesConfig.getChannels().get(mobileMsgTemplate.getTemplate());
